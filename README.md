...
![SEO Writing Sub Section Screenshot](assets/images/readme/responsiveness/sub_seo_resp.png "SEO Writing by A.K. Amherst")

### Reading Beloved Paul - Responsive
![SEO Writing Sub Section Screenshot](assets/images/readme/responsiveness/sub_readstory_resp.png "SEO Writing by A.K. Amherst")
------
...
![Title Img Short Stories](assets/images/readme/features/shortstories/titleimgshort.png)
...
![Testing index.html Screenshot](assets/images/validation/stage_1/index_validation.png "Testing index.html for A.K.Amherst website").
...
![Testing subpages Screenshot](/assets/images/validation/stage_1/subpages_warning.png "Testing subpages for A.K.Amherst website").
...
![Testing CSS Screenshot](assets/images/validation/stage_1/subpages_warning.png "Testing CSS for A.K.Amherst website").
...
Main Page:
![Testing HTML Main Page ](assets/images/validation/stage_2/html/mainpage_html.png "Testing the new main page for HTML errors").

About Page:
![Testing HTML About Page ](assets/images/validation/stage_2/html/about_html.png "Testing the slightly adapted About page for HTML errors").

Books Page:
![Testing HTML Books Page ](assets/images/validation/stage_2/html/books_html.png "Testing the slightly adapted Books page for HTML errors").

SEO Writing Page:
![Testing HTML SEO Page ](assets/images/validation/stage_2/html/seowriting_html.png "Testing the slightly adapted SEO page for HTML errors").

Short Stories Page:
![Testing HTML Short Stories Page ](assets/images/validation/stage_2/html/shortstories_html.png "Testing the slightly adapted Short Stories page for HTML errors").

Running Sushi (Reading Short Stories) Page:
![Testing HTML Running Sushi Page ](assets/images/validation/stage_2/html/runningsushi_html.png "Testing the slightly adapted Running Sushi page for HTML errors").

Beloved Paul (Reading Short Stories) Page:
![Testing HTML Beloved Paul Page ](assets/images/validation/stage_2/html/belovedpaul_html.png "Testing the slightly adapted Beloved Paul page for HTML errors").
...
CSS
Main Page
![Testing CSS Main Page ](assets/images/validation/stage_2/css/css_pages.png "Testing the new main page for CSS errors").

Subpages
![Testing CSS Subpages Page ](assets/images/validation/stage_2/css/css_subpages.png "Testing the slightly adapted subpages for CSS errors").

Warnings in CSS

In both cases there were warnings stating that the font names used should always be in double quotation marks to avoid problems. I checked both files and all of the font names are in double quotation marks. I don't think this is an actual problem of my CSS but rather a bug in the CSS validator.
![Testing CSS Main Page ](assets/images/validation/stage_2/css/warnings_css.png "Testing the new main page for CSS errors").
![Testing CSS Subpages Page ](assets/images/validation/stage_2/css/warnings_subpages_css.png "Testing the slightly adapted subpages for CSS errors").
